...
f=&amp;a=x86_32&amp;path0=' + str(dlist_id-250)+'&amp;path1='+str(dlist_id+250)
    return url
#####
def generateLink(pic_name,dlistid_set_per_second,runtime_percentage_per_pid,loc_max):
    path_name = 'dcg/'
    rect_width =85
...
#####
    ...
    #######################
		...
		########################################################
			...
			runtime_temp = round(runtime_percentage_per_pid[count][i],4)*100
